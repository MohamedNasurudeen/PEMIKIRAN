...
public class Contacts_Existing_Organization_Sce4 {
	...
	public static void main(String[] args) {
		WebDriver driver = new ChromeDriver();
	      ...
	      driver.findElement(By.name("lastname")).sendKeys("Rasith");
	        String currentwindow = driver.getWindowHandle();
	        driver.findElement(By.xpath("(//img[@src='themes/softed/images/select.gif'])[1]")).click();	    
	        Set<String> newwindowopen = driver.getWindowHandles();

//	        String organizationpage = driver.findElement(By.className("moduleName")).getText();
//	        if(organizationpage.contains("Organizations"))
//	        	System.out.println("organization page should be open-------Testcase Pass");
//	        else
//	        	System.out.println("organization page should not be open-------Testcase Fail");
	      ...
	      String contactsinfo = driver.findElement(By.xpath("//span[@class='dvHeaderText']")).getText();
	       if(contactsinfo.contains("Mohamed"))
		    ...
		    String newcontactstable = driver.findElement(By.xpath("//table[@class='lvt small']/descendant::tr[last()]/td[4]/a")).getText();
		     if(newcontactstable.equals("Rasith"))
